                ...
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="js-example-basic-single form-control" name="category" data-toggle="select2">
                                        <option value="" selected="">Përzgjidh...</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="barcode">{{ __('Barkodi') }}<span class="text-danger">*</span></label>
                                    <p class="text-muted">{{__('Gjeneroni barkod automatikisht duke klikuar butonin e refresh.')}}</p>
                                    <div class="input-group">
                                        <input type="text" name="barcode" id="barcode"
                                               value="{{ old('barcode') }}"
                                               class="form-control @error('barcode') is-invalid @enderror"
                                               placeholder="{{ __('Vendosni barkodin e produktit') }}" required>
                        ...
                        <div>
                            ...
                            <textarea name="description" id="ckeditor-classic" id="description">{{ old('description') }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="input-group">
                                <input type="file" name="thumbnail" class="form-control" id="inputGroupFile03" aria-describedby="inputGroupFileAddon03" aria-label="Upload">
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="special_discount_type" id="special_discount_type">
                                        <option selected disabled>{{ __('Përzgjidh tipin') }}</option>
                                        <option value="flat" {{ old('special_discount_type') == 'flat' ? 'selected' : '' }}>{{ __('Flat') }}</option>
                                        <option value="percentage" {{ old('special_discount_type') == 'percentage' ? 'selected' : '' }}>{{ __('Percentage') }}</option>
                                    </select>
                        ...
                        <div class="row mb-4">
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('special_discount_start') is-invalid @enderror" id="manufacturer-brand-input" name="special_discount_start" value="{{ old('special_discount_start') != '' ? old('special_discount_start') : '' }}">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input type="date" class="form-control @error('special_discount_end') is-invalid @enderror" id="manufacturer-brand-input" name="special_discount_end">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="low_stock_to_notify">{{ __('Paralajmërimi për min stok') }} <span class="text-danger">*</span></label>
                                    <input type="number" name="low_stock_to_notify"
                                           value="{{ old('low_stock_to_notify')}}"
                                           class="form-control"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control js-example-basic-single" name="stock_visibility" id="stock_visibility">
                                        <option value="visible_with_quantity" {{ old('stock_visibility') == 'visible_with_quantity' ? 'selected' : ''}}>{{ __('Shfaqur me sasinë') }}</option>
                                        <option value="visible_with_text" {{ old('stock_visibility') == 'visible_with_text' ? 'selected' : '' }}>{{ __('Shfaqur me tekst') }}</option>
                                    </select>
                        ...
                        <div class="with-variant {{ old('has_variant') == 1 ? '' : 'd-none' }}">
                            ...
                            <div class="form-group row variant-table">
                                @if(session()->has('attributes'))
                                    @include('backend.product.products.sku-variant')
                                @endif
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="tab-content">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                <input type="text" class="form-control @error('weight') is-invalid @enderror" id="product-price-input" name="weight" placeholder="Pesha në gram" aria-label="Price" aria-describedby="product-price-addon">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group has-validation mb-3">
                                                <input type="text" class="form-control @error('length') is-invalid @enderror" id="product-price-input" name="length" placeholder="Gjatësia në cm" aria-label="Price" aria-describedby="product-price-addon">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control @error('wide') is-invalid @enderror" id="product-discount-input" name="wide" placeholder="Gjerësia në cm" aria-label="discount" aria-describedby="product-discount-addon">
                                    ...
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" class="form-control @error('height') is-invalid @enderror" id="product-discount-input" name="height" placeholder="Lartësia në cm" aria-label="discount" aria-describedby="product-discount-addon">
                                                <span class="input-group-text" id="product-discount-addon">cm</span>
                                                @error('height')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                            ...
                            <div class="tab-pane" id="addproduct-metadata" role="tabpanel">
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('meta_title') is-invalid @enderror" placeholder="Titulli për SEO" id="meta-title-input">
                                            @error('meta_title')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('meta_keywords') is-invalid @enderror" name="meta_keywords" placeholder="Fjalë kyçe për SEO" id="meta-keywords-input">
                                            @error('meta_keywords')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div>
                                    ...
                                    <textarea class="form-control @error('meta_description') is-invalid @enderror" id="meta-description-input" name="meta_description" placeholder="Përshkrimi për SEO" rows="3"></textarea>
                                ...
                                @foreach ($filter_attributes as $filter_attribute)
                                    ...
                                    @foreach ($filter_attribute->filterAttributeValue as $filter_attribute_value)
                                        <div class="form-check form-check-success ms-3 mb-3">
                                            <input class="form-check-input" type="checkbox" id="{{ $filter_attribute_value->value }}{{ $filter_attribute_value->id }}" name="filter_attribute_id[]" value="{{ $filter_attribute_value->id }}">
