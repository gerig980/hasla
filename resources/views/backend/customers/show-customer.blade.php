    ...
    <div class="container-fluid">
        ...
        <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
            <div class="row g-4">
                ...
                <div class="col">
                    <div class="p-2">
                        <h3 class="text-white mb-1">{{ $singleCustomer->name }}</h3>
                                                ...
                                                <table class="table table-borderless mb-0">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td class="text-muted">{{ $singleCustomer->name }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">Mobile :</th>
                                                            <td class="text-muted">{{ $singleCustomer->phone }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th class="ps-0" scope="row">E-mail :</th>
                                                            <td class="text-muted">{{ $singleCustomer->email }}</td>
                                                        </tr>
                                                        
                                                        <tr>
                                                            <th class="ps-0" scope="row">Dita regjistrimit</th>
                                                            <td class="text-muted">{{ $singleCustomer->created_at }}</td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                                            </div>
